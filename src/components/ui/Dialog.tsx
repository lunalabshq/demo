    ...
    return (
        <DialogPrimitive.Portal>
            ...
            <DialogPrimitive.Content
                className={cn(
                    "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-main",
                    "bg-primary p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0",
                    ...
                    "data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-md",
                    className
                )}
                ref={ref}
                {...props}
            >
                ...
                <DialogPrimitive.Close
                    className={cn(
                        ...
                        "focus:outline-none disabled:pointer-events-none data-[state=open]:bg-primary",
                        "data-[state=open]:text-secondary text-secondary hover:text-primary"
                    )}
                >
                    <X className="h-4 w-4" />
